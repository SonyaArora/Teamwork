  ...
  getCoursesForTopic(topic) {
    ...
    if (topic === "art") {
      ...
      matchingCourses.push({
        ...
        name: "Dude Person",
        short_summary: "It's a cool AWESOME place for kids and adults to play have fun and there's also some fun in learning FUN FUN FUN FUN FUN FUN FUN FUN FUN FUN FUN FUN",
        teacher: "SOMEONE!",
        record__id: "C00L"
      });
    } else if (topic === "pe") {
